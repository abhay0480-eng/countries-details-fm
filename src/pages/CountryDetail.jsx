  ...
  return (
    ...
    <div className={`pt-12 max-w-7xl mx-auto `}>
        ...
        <div>
            ...
            <div>
            {countryDetail[0]?.borders &&<p className='font-semibold text-[14px] flex items-center mb-5'>Border Countries: <span className='font-light flex'>{countryDetail[0]?.borders?.map((border,index)=><div key={index} className='border-[1px] border-[#979797] p-4 mx-2'>{border}</div>)}</span></p>}
