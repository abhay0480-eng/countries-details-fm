...
const Header = () => {
  ...
  return (
    <div className={`flex justify-between p-3 ${theme?"bg-white text-[#111517]":"bg-[#2B3844] text-white"} px-8  lg:px-20`}>
        <div className={`lg:text-[24px] text-[14px] font-extrabold`}><Link to="/">Where in the world?</Link></div>
